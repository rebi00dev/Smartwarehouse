...
# Generate ROS 2 package manifest and import source code using rosinstall_generator and vcs
RUN mkdir -p ${ROS_ROOT}/src && \
    ...
    urdf kdl_parser robot_state_publisher \
    nav2_msgs \
